...
TXT ファイルを読み取り、AI が簡易的な説明文を生成します。  
※ Word / Excel / PDF / PPT などは簡易的なテキスト抽出のみ対応（文字化けする場合があります）
...
- 📁 フォルダ一括取り込み  
  Word / Excel / PDF / PPT / TXT を完全対応。  
  表・段落・箇条書き・図表のテキスト抽出に対応し、  
  RAG による高精度な理由文生成が可能です。
